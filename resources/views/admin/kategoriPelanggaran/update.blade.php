...
@section('content')
    <div class="col-sm-4 col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation custom-input" action="{{ route('kategori-pelanggaran.update', ['id' => $kategori->id_kategori_pelanggaran]) }}"
                    method="POST" novalidate="">
                    @csrf
                    <div class="col-md-12 position-relative">
                        <label class="form-label" for="kategoriPelanggaran">Kategori Pelanggaran</label>
                        <input class="form-control" id="kategoriPelanggaran" type="text" name="nama_kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}"
